...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__v",
      "vtp_name":"fileRelationId",
      "vtp_dataLayerVersion":2
    },{
      "function":"__v",
      "vtp_setDefaultValue":false,
      "vtp_name":"guideAction",
      "vtp_dataLayerVersion":2
    },{
      "function":"__v",
  ...
  "tags":[{
      ...
      "vtp_dimension":["list",["map","index","1","dimension",["macro",3]]],
      "vtp_metric":["list"],
      ...
      "vtp_dimension":["list",["map","index","2","dimension",["macro",10]],["map","index","1","dimension",["macro",3]]],
      "vtp_metric":["list"],
      "vtp_useDebugVersion":false,
      "vtp_enableLinkId":false,
      "vtp_doubleClick":true,
      ...
      "vtp_enableLinkId":false,
      "vtp_eventCategory":"guideToDlsite",
...
var Jd=[C.B,C.J],Kd=function(a){var b=a[C.Od];b&&D(40);var c=a[C.Pd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Od&&f!==C.Pd)if(-1<Ha(Jd,f)){var h=f,k=a[f],l=d[e];ud().set(h,k,l,"HK","",c)}else{}},Ld=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
null))}return!1};var de=/:[0-9]+$/,ee=function(a,b,c){for(var d=a.split("&"),e=0;e<d.length;e++){var f=d[e].split("=");if(decodeURIComponent(f[0]).replace(/\+/g," ")===b){var h=f.slice(1).join("=");return c?h:decodeURIComponent(h).replace(/\+/g," ")}}},he=function(a,b,c,d,e){b&&(b=String(b).toLowerCase());if("protocol"===b||"port"===b)a.protocol=fe(a.protocol)||fe(G.location.protocol);"port"===b?a.port=String(Number(a.hostname?a.port:G.location.port)||("http"==a.protocol?80:"https"==a.protocol?443:"")):"host"===b&&
...
x,v);else{var E=u.vtp_attribute,H=a(t,"element");F=H&&ld(H,E)||v||""}return F;case "MD":var M=u.vtp_mdValue,N=b(t,"MD",Km);return M&&N?Nm(N,M)||v:N||v;case "FORM":return f(String(u.vtp_component||"SUBMIT_TEXT"),t,v);default:var S=c(t,x,v);dn(S,"aev",u.vtp_gtmEventId);return S}})}();
